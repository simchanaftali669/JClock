...
function Tefila()
{
	...
	else if(curr_hour >= birkutHashahar && curr_hour < patachEliyaou)
	{
		...
		document.querySelector("#Mazal").innerText = "ברכות השחר";
		//console.log(1);
		//BirkutHashahar(secLeft);
	}
	else if(curr_hour >= patachEliyaou && curr_hour < korbanot)
	{
		...
		document.querySelector("#Mazal").innerText = "פתח אליהו";
	...
	else if(curr_hour >= korbanot && curr_hour < psokeiDzimra)
	{
		...
		document.querySelector("#Mazal").innerText = "קורבנות";
		//Korbanot(secLeft);
	}
	else if(curr_hour >= psokeiDzimra && curr_hour < nishmat)
	{
		//console.log(4);
		var secLeft = SecLeft(curr_hour,nishmat);
		document.querySelector("#Mazal").innerText = "פסוקי דזמרה";
		//Nishmat(secLeft);
	}
	else if(curr_hour >= nishmat && curr_hour < yozerOr)
	{
		//console.log(5);
		var secLeft = SecLeft(curr_hour,yozerOr);
		document.querySelector("#Mazal").innerText = "נשמת כל-חי";		
	...
	else if(curr_hour >= yozerOr && curr_hour < kriyahtShema)
	{
		...
		document.querySelector("#Mazal").innerText = "יוצר אור";
		//YozerOr(secLeft);
	}
	else if(curr_hour >= kriyahtShema && curr_hour < publicSunrise)
	{
		...
		document.querySelector("#Mazal").innerText = "קריאת שמע";		

...
function setmazal() {
    ...
    {				
		...
		var shevet1 = ["Dummy","יהודה", "יששכר", "זבולון", "ראובן", "שמעון", "גד", "אפרים","מנשה","בנימין","דן","אשר","נפתלי-לוי"];
		var shevet2 = ["Dummy","ראובן", "שמעון", "לוי", "יהודה","דן","נפתלי","גד","אשר","יששכר","זבולון","יוסף","בנימין"];

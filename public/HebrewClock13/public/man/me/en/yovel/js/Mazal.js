...
//        day = 1;
    ...
    // var day_mida = ["خسد", "جفوراه", "تفئرت", "نتصخ", "هود", "يسود", "ملخوت"];
    // var x = 0;
    // if (day == 1)
    //     x = (5 + clockHour) % 7;
    // if (day == 2)
    ...
    var shevet__mida = ["Bina", "Netzach", "Hod", "Faith", "Will", "Gvura", "Yesod(give)","Yesod(recive)","Malcut", "wisdom","Tife'ret","Chesed(idea)"];
    var shevet = ["Yehuda", "Yissachar", "Zevulun", "Reuven", "Shimon", "Gad", "Ephraim","Menashe","Benjamin","Dan","Asher","Naftali(Levi)"];
    ...
    // switch (x) {
    //     case (0):
    //         //document.getElementById("Mazal").value = day_mida[0] + " بداخل " + day_mida[day - 1];
    //         document.body.style.backgroundImage = "url('../pic/1.jpg')";
    //         //omer = ((day - 1) * 7) + 1;
    //         break;
    //     case (1):
    //         //document.getElementById("Mazal").value = day_mida[1] + " بداخل " + day_mida[day - 1];
    //         document.body.style.backgroundImage = "url('../pic/2.jpg')";
    //         //omer = ((day - 1) * 7) + 2;
    //         break;
    //     case (2):
    //         //document.getElementById("Mazal").value = day_mida[2] + " بداخل " + day_mida[day - 1];
    //         document.body.style.backgroundImage = "url('../pic/3.jpg')";
    //         //omer = ((day - 1) * 7) + 3;
    //         break;
    //     case (3):
    //         //document.getElementById("Mazal").value = day_mida[3] + " بداخل " + day_mida[day - 1];
    //         document.body.style.backgroundImage = "url('../pic/4.jpg')";
    //         //omer = ((day - 1) * 7) + 4;
    //         break;
    //     case (4):
    //         //document.getElementById("Mazal").value = day_mida[4] + " بداخل " + day_mida[day - 1];
    //         document.body.style.backgroundImage = "url('../pic/5.jpg')";
    //         //omer = ((day - 1) * 7) + 5;
    //         break;
    //     case (5):
    //         //document.getElementById("Mazal").value = day_mida[5] + " بداخل " + day_mida[day - 1];
    //         document.body.style.backgroundImage = "url('../pic/6.jpg')";
    //         //omer = ((day - 1) * 7) + 6;
    //         break;
    //     case (6):
    //         //document.getElementById("Mazal").value = day_mida[6] + " بداخل " + day_mida[day - 1];

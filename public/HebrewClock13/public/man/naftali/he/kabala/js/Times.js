...
//		hour[30] = Math.floor(shaa_zmanit_day * 3600.0 * 1000);      //day
        ...
        var s1, s2,s3,s4,shaa_zmanit,scheduleDate;
        if (curr_hour > sunset_hour) 
				{
            s1 = sunset;
            s2 = sunrise_tommorow;
...
//		{
			...
			//document.getElementById("hour_together").value = "יחד";
...
/*		}
		...
		{
			document.getElementById("sunrise").value = timeadj(s4, ampm);
			document.getElementById("sunrise__label").value = "שקיעה";
			document.getElementById("hour_6__value").value = timeadj(s4 + shaa_zmanit_night*5 , ampm);
			document.getElementById("hour_6__label").value = "סעודת לילה";
			document.getElementById("chatzot_yom").value = timeadj(s4 + shaa_zmanit_night*6 , ampm);
			document.getElementById("mincha_ketana").value = timeadj(s4 + shaa_zmanit_night*9.5 , ampm);
			document.getElementById("plag_mincha").value = timeadj(s4 + shaa_zmanit_night*10.75 , ampm);
			document.getElementById("sunset").value = timeadj(s4, ampm);
		}
*/		
		var time;
		...
		// 	document.getElementById("misheyakir").value = timeadj(time[2], ampm);
		 ...
		 if (time[1] == 0)
            setScheduleDisplayTime("tziet", time[3], curr_hour > sunset_hour ? tomorrow : today);

...
function markTime()
{
	...
	else if(curr_hour > misheyakir/*curr_hour.toDouble() > sunrise_hour.toDouble()*/ )
	{
		document.getElementById("ChirstianHour").style.color = "#5DBCD2";
		document.getElementById("ChirstianDots1").style.color = "#5DBCD2";
		document.getElementById("ChirstianMinute").style.color = "#5DBCD2";
		document.getElementById("ChirstianDots2").style.color = "#5DBCD2";
		document.getElementById("ChirstianSecond").style.color = "#5DBCD2";
